...
@interface URLWKWebViewController ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation URLWKWebViewController
...
//    [self.webView loadRequest:request];
    ...
    NSString *urlStr = [[NSBundle mainBundle] pathForResource:@"index0.html" ofType:nil];
