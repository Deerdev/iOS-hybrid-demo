...
- (void)registAlertFunction
{
    // 注册的handler 是供 JS调用Native 使用的。
    [_webViewBridge registerHandler:@"alertClick" handler:^(id data, WVJBResponseCallback responseCallback) {
