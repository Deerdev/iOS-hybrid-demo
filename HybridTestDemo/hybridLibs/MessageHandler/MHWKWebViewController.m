...
@interface MHWKWebViewController ()<WKUIDelegate,WKScriptMessageHandler>
...
@implementation MHWKWebViewController
...
- (void)initWKWebView
{
    ...
    [configuration.userContentController addScriptMessageHandler:self name:@"alertAction"];
//
